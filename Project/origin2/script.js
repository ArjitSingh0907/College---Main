document.addEventListener("DOMContentLoaded", () => {
    ...
    if (heroTitle && typeof SITE_DATA !== "undefined") {
        heroTitle.innerText = SITE_DATA.hero.title;
        heroTagline.innerText = SITE_DATA.hero.tagline;
        heroDate.innerText = SITE_DATA.hero.date;
        heroVenue.innerText = SITE_DATA.hero.venue;
    }

    const aboutContainer = document.getElementById("about-container");
    if (aboutContainer && typeof SITE_DATA !== "undefined") {
    ...
    if (flipGrid && typeof SITE_DATA !== "undefined") {
    ...
    if (timelineContainer && typeof SITE_DATA !== "undefined") {
    ...
    if (pathwaysGrid && typeof SITE_DATA !== "undefined") {
    ...
    if (legacyEventsGrid && typeof SITE_DATA !== "undefined") {
    ...
    if (galleryTrack && typeof SITE_DATA !== "undefined") {
    ...
    function checkNavSplit() {
        if (!heroSection || !navWrapper || !bottomDock) return;
